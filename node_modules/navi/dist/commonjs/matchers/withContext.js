...
function withContext(childContextMaybeResolvable, forceChild) {
    ...
    function contextMatcherGenerator(request, child) {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [5 /*yield**/, __values(Resolvable_1.default(childContextMaybeResolvable, request, function (childContext) {
                        return Matcher_1.createMatcherIterator(child, __assign(__assign({}, request), { context: childContext || {} }));
                    }))];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
