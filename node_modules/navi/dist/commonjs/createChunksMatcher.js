        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, [Chunks_1.createNotFoundChunk(request)]];
                case 1:
                    _a.sent();
                    return [3 /*break*/, 4];
                case 2:
                    parentIterator = ((request.crawler && !processDuringCrawl) || (predicate && !predicate(request)))
                        ? empty()
                        : Resolvable_1.default(maybeResolvable, request, function (value) { return getChunks(value, request); });
                    return [5 /*yield**/, __values((child ? Matcher_1.concatMatcherIterators(parentIterator, Matcher_1.createMatcherIterator(child, request)) : parentIterator))];
                case 3:
                    _a.sent();
                    _a.label = 4;
...
exports.createChunksMatcher = createChunksMatcher;
function empty() {
    return __generator(this, function (_a) {
        switch (_a.label) {
...
//# sourceMappingURL=createChunksMatcher.js.map