    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                busyChunks = [Chunks_1.createChunk('busy', request, { promise: promise })];
                _a.label = 2;
            case 2:
            ...
            case 4:
                ...
                if (error instanceof Errors_1.NotFoundError && !error.pathname) {
                    error.pathname = URLTools_1.joinPaths(request.mountpath, request.path);
                }
                return [4 /*yield*/, [Chunks_1.createChunk('error', request, { error: error })]];
            case 5:
                _a.sent();
                return [3 /*break*/, 7];
            case 6:
