        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    url = URLTools_1.createURLDescriptor(options.root || '');
                            ...
                            switch (_a.label) {
                                ...
                                case 1:
                                    ...
                                    return [2 /*return*/, patterns
                                            ...
                                            url: URLTools_1.createURLDescriptor(URLTools_1.joinPaths(parentRequest.mountpath, pattern)),
                    ...
                    return [4 /*yield*/, Observable_1.createPromiseFromObservable(chunkListObservable)
                ...
                case 1:
                    ...
                    return [2 /*return*/, {
                            paths: options.trailingSlash !== null
                                ? paths.map(function (path) { return URLTools_1.modifyTrailingSlash(path, options.trailingSlash || 'remove'); })
                                : paths,
                            redirects: redirects,
                        }];
            }
