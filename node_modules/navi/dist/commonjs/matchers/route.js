...
var withHead_1 = require("./withHead");
var withHeaders_1 = require("./withHeaders");
var withState_1 = require("./withState");
var withStatus_1 = require("./withStatus");
...
function route(options) {
    ...
    return compose_1.compose(withContext_1.withContext(function (req, context) {
        return req.crawler ? {} : contextGetter(req, context);
    }), withData_1.withData(function (req) { return req.context.data; }), withHead_1.withHead(function (req) { return req.context.head; }), withHeaders_1.withHeaders(function (req) { return req.context.headers; }), withState_1.withState(function (req) { return req.context.state || null; }), withStatus_1.withStatus(function (req) { return req.context.status; }), withTitle_1.withTitle(function (req) { return req.context.title; }), withView_1.withView(function (req) { return req.context.view; }, undefined, true), createChunksMatcher_1.createChunksMatcher(function (req) { return req.context.error; }, undefined, function (error, request) { return (error ? [Chunks_1.createChunk('error', request, { error: error })] : []); }));
}
exports.route = route;
