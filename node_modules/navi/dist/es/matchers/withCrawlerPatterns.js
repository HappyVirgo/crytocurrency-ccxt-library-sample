...
export function withCrawlerPatterns(crawlablePatterns, forceChild) {
    var _this = this;
    var crawlerResolvable = function (request) {
        return function (pattern, parentRequest) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [5 /*yield**/, __values(createMatcherIterator(child, request))];
                case 1:
                    _a.sent();
                    return [3 /*break*/, 4];
                case 2: return [5 /*yield**/, __values(resolveChunks(crawlerResolvable, request, function (crawler) {
                        return createMatcherIterator(child, __assign(__assign({}, request), { crawler: crawler }));
                    }))];
                case 3:
                    _a.sent();
                    _a.label = 4;
...
//# sourceMappingURL=withCrawlerPatterns.js.map