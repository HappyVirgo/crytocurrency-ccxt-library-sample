        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [5 /*yield**/, __values(Matcher_1.createMatcherIterator(child, request))];
                case 1:
                    _a.sent();
                    return [3 /*break*/, 4];
                case 2: return [5 /*yield**/, __values(Resolvable_1.default(crawlerResolvable, request, function (crawler) {
                        return Matcher_1.createMatcherIterator(child, __assign(__assign({}, request), { crawler: crawler }));
                    }))];
                case 3:
                    _a.sent();
                    _a.label = 4;
